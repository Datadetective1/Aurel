...
import { brand, seoTitle, siteUrl } from '@/lib/brand'
import './globals.css'
...
export const metadata: Metadata = {
  ...
  title: { default: seoTitle(), template: `%s · ${brand.name}` },
  ...
  // apple-icon is generated by src/app/apple-icon.tsx; declaring it here too
  // would override the file convention and point back at the 404 it replaced.
  icons: { icon: '/icon.svg' },
